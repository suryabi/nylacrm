...
self.addEventListener('push', (event) => {
  ...
  let data = { title: 'Nyla CRM', body: 'You have a new notification' };
...
async function syncActivity() {
  // This would sync any offline activity data when connection is restored
  console.log('[ServiceWorker] Syncing activity data');
}
