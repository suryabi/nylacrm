...
export default function TargetSKUReport() {
  ...
  const sortedData = [...filteredData].sort((a, b) => {
    ...
    if (sortField === 'target_revenue' || sortField === 'achieved_revenue' || sortField === 'tbd_revenue') {
  ...
  return (
    <div className="space-y-6" data-testid="target-sku-report">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">SKU allocation across sales targets</p>
        </div>
        {reportData.length > 0 && (
