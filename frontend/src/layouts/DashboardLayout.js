...
const navigation = [
  { name: 'Dashboard', href: '/dashboard', icon: LayoutDashboard, roles: ['admin', 'sales_manager', 'sales_rep'] },
  ...
  { name: 'Locations', href: '/locations', icon: MapPin, roles: ['admin', 'sales_manager'] },
