...
const salesNavigationGroups = [
  {
    ...
    items: [
      ...
      { name: 'Account SKU Pricing', href: '/accounts/sku-pricing', icon: Package, moduleKey: 'accounts', roles: ['CEO', 'Director', 'Vice President', 'National Sales Head', 'Regional Sales Manager', 'Head of Business', 'Partner - Sales', 'Sales Partner', 'Sales Rep', 'Admin', 'System Admin'] },
