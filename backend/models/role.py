...
DEFAULT_MODULE_PERMISSIONS = {
    ...
    "customer_complaints": {"view": False, "create": False, "edit": False, "delete": False},
    "gamma_generator": {"view": False, "create": False, "edit": False, "delete": False},
...
MODULE_CATEGORIES = {
    ...
    "Operations": ["lead_discovery", "target_planning", "performance_tracker", "investor_dashboard", "daily_status", "meeting_minutes", "personal_calendar", "status_summary", "customer_complaints"],
