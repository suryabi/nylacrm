...
from .accounting_transactions import router as accounting_transactions_router
...
routes_router.include_router(accounting_transactions_router, tags=["Accounting Transactions"])
