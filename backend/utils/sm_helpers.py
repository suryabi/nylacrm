...
_DEFAULT_MR_TRANSITIONS = [
    ...
    {"action_key": "approve",                  "action_label": "Internal Approve",       "from_state": "in_review",         "to_state": "approved_internal", "guards": {"match": "all", "conditions": [{"field": "approved_versions", "op": "not_empty", "message": "Choose a work version before this action."}]}},
    ...
    {"action_key": "final_approve",            "action_label": "Final Approve",          "from_state": "approved_internal", "to_state": "final_approved", "requestor_only": True, "guards": {"match": "all", "conditions": [{"field": "approved_versions", "op": "not_empty", "message": "Choose a work version before this action."}]}},
