...
- [x] **Territory/City/Resource View (2026-04-01)**: Added "View By" selector (Territory/City/Resource) to Performance Tracker. Territory and City views resolve to underlying resources and aggregate metrics. Backend endpoints added for territories-for-plan, cities-for-plan, resources-by-territory, resources-by-city
